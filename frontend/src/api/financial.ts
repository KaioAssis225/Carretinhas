...
export interface FinancialSummary { rental_id: string; charges: ChargeData[]; payments: PaymentData[]; charge_total: string; paid_total: string; balance_due: string; pickup_minimum_payment: string; pickup_payment_met: boolean }
